function [density] = destroyed(strutthickness,sigma_nucleus,sigma_node,type)
...
filename = ["V", sigma_nucleus, "_N", sigma_node, "_", type, ".csv"];
...
%csvwrite(filename, finalshape.Vertices)
